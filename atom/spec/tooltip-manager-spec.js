...
describe('TooltipManager', function () {
  ...
  return describe('::add(target, options)', function () {
    ...
    describe("when the trigger is 'manual'", () => it('creates a tooltip immediately and only hides it on dispose', function () {
    ...
    describe("when the trigger is 'click'", () => it('shows and hides the tooltip when the target element is clicked', function () {
    ...
    describe('when a keyBindingCommand is specified', function () {
      describe('when a title is specified', () => it('appends the key binding corresponding to the command to the title', function () {
      ...
      describe('when no title is specified', () => it('shows the key binding corresponding to the command alone', function () {
    ...
    describe('when .dispose() is called on the returned disposable', () => it('no longer displays the tooltip on hover', function () {
    ...
    describe('when the window is resized', () => it('hides the tooltips', function () {
      const disposable = manager.add(element, { title: 'Title' })
      return hover(element, function () {
        expect(document.body.querySelector('.tooltip')).not.toBeNull()
