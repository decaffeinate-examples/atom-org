...
describe('text utilities', function () {
  describe('.hasPairedCharacter(string)', () => it('returns true when the string contains a surrogate pair, variation sequence, or combined character', function () {
  ...
  describe('.isPairedCharacter(string, index)', () => it('returns true when the index is the start of a high/low surrogate pair, variation sequence, or combined character', function () {
  ...
  describe('.isDoubleWidthCharacter(character)', () => it('returns true when the character is either japanese, chinese or a full width form', function () {
  ...
  describe('.isHalfWidthCharacter(character)', () => it('returns true when the character is an half width form', function () {
  ...
  describe('.isKoreanCharacter(character)', () => it('returns true when the character is a korean character', function () {
  ...
  return describe('.isWrapBoundary(previousCharacter, character)', () => it('returns true when the character is CJK or when the previous character is a space/tab', function () {
