...
`
  ...
  it('tokenizes character escapes in strings', function () {
    ...
    for (const escape of Array.from(escapes)) {
  ...
  it('tokenizes keywords', function () {
    ...
    return (() => {
      ...
      for (var scope in keywordLists) {
        ...
        result.push((() => {
          const result1 = []
          for (const keyword of Array.from(list)) {
  ...
  it('tokenizes func regardless of the context', function () {
    ...
    return (() => {
      const result = []
      for (const t of Array.from(funcType)) {
  ...
  it('tokenizes func names in their declarations', function () {
    ...
    return (() => {
      const result = []
      for (const t of Array.from(tests)) {
  ...
  it('tokenizes built-in functions', function () {
    ...
    return (() => {
      const result = []
      for (const func of Array.from(funcs)) {
