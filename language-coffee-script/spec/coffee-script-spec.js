...
`
  ...
  it('tokenizes compound operators properly', function () {
    ...
    for (const assignmentOperator of Array.from(assignmentOperators)) {
    ...
    for (const bitwiseOperator of Array.from(bitwiseOperators)) {
    ...
    return (() => {
      const result = []
      for (const comparisonOperator of Array.from(comparisonOperators)) {
  ...
  it('tokenizes operators properly', function () {
    ...
    for (const logicalOperator of Array.from(logicalOperators)) {
    ...
    for (const decrementOperator of Array.from(decrementOperators)) {
    ...
    for (const incrementOperator of Array.from(incrementOperators)) {
    ...
    for (const splatOperator of Array.from(splatOperators)) {
    ...
    for (const existentialOperator of Array.from(existentialOperators)) {
  ...
  it('does not tokenize non-operators as operators', function () {
    ...
    return (() => {
      const result = []
      for (const notOperator of Array.from(notOperators)) {
