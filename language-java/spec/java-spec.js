...
`
    ...
    return expect(lines[14][1]).toEqual({ value: 'TestClass', scopes: ['source.java', 'meta.definition.variable.java', 'storage.type.java'] })
  })
...
`
    ...
    return expect(lines[9][19]).toEqual({ value: 'start', scopes: expected })
  })
...
`
    ...
    return expect(lines[5][13]).toEqual({ value: ')', scopes: ['source.java', 'meta.class.java', 'meta.class.body.java', 'meta.method.java', 'meta.method.body.java', 'meta.catch.java', 'punctuation.definition.parameters.end.bracket.round.java'] })
  })
...
`
  ...
  return it('tokenizes annotations within classes', function () {
    const lines = grammar.tokenizeLines(`\
class A {
