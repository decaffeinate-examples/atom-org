...
var merge = function (menu, item, itemSpecificity) {
  ...
  if (matchingItem != null) {
    if (item.submenu != null) {
      for (const submenuItem of Array.from(item.submenu)) { merge(matchingItem.submenu, submenuItem, itemSpecificity) }
...
var unmerge = function (menu, item) {
  ...
  if (matchingItem != null) {
    if (item.submenu != null) {
      for (const submenuItem of Array.from(item.submenu)) { unmerge(matchingItem.submenu, submenuItem) }
    }
