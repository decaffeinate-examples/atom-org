...
class StylesElement extends HTMLElement {
  ...
  contextChanged () {
    ...
    for (const child of Array.from(Array.prototype.slice.call(this.children))) { this.styleElementRemoved(child) }
    this.context = this.getAttribute('context')
    for (const styleElement of Array.from(this.styleManager.getStyleElements())) { this.styleElementAdded(styleElement) }
  }
