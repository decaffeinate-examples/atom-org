...
describe('SCSS grammar', function() {
    ...
    return (() => {
      ...
      for (var scope in selectors) {
        ...
        it(`tokenizes complex ${scope} selectors`, function() {
          const {tokens} = grammar.tokenizeLine(`${selector}legit-#\{$selector}-name\\@sm`);
          ...
          return expect(tokens[7]).toEqual({value: "sm", scopes: ["source.css.scss", `entity.other.attribute-name.${scope}.css`]});
      });

        it(`tokenizes invalid identifiers in ${scope} selectors`, function() {
          const {tokens} = grammar.tokenizeLine(`${selector}legit-#\{$selector}-n}a$me\\@sm`);
          ...
          return expect(tokens[11]).toEqual({value: "sm", scopes: ["source.css.scss", `entity.other.attribute-name.${scope}.css`]});
      });
  ...
  describe("attribute selectors", function() {
    ...
    it("tokenizes complex attribute selectors", function() {
      const {tokens} = grammar.tokenizeLine("[cla#\{$s}^=abc#\{d}e]");
      ...
      return expect(tokens[11]).toEqual({value: "]", scopes: ["source.css.scss", "meta.attribute-selector.scss", "punctuation.definition.attribute-selector.end.bracket.square.scss"]});
  });
  ...
  describe('@include', () => it('tokenizes it correctly', function() {
    ...
    return expect(tokens[11]).toEqual({value: '{', scopes: ['source.css.scss', 'meta.property-list.scss', 'punctuation.section.property-list.begin.bracket.curly.scss']});
}));
  ...
  describe('@mixin', function() {
    ...
    return it('tokenizes @mixin with arguments correctly', function() {
      const {tokens} = grammar.tokenizeLine('@mixin media ($width){}');
      ...
      return expect(tokens[8]).toEqual({value: '{', scopes: ['source.css.scss', 'meta.property-list.scss', 'punctuation.section.property-list.begin.bracket.curly.scss']});
  });
});
...
`
    ...
    return describe('property values', () => it('tokenizes parentheses', function() {
      const {tokens} = grammar.tokenizeLine('.foo { margin: ($bar * .8) 0 ($bar * .8) ($bar * 2);');
      ...
      return expect(tokens[32]).toEqual({value: ')', scopes: ['source.css.scss', 'meta.property-list.scss', 'meta.property-value.scss', 'punctuation.definition.end.bracket.round.scss']});
  }));
});
...
`
  ...
  describe('pseudo classes', function() {
    ...
    return it("tokenizes complex pseudo classes", function() {
      const {tokens} = grammar.tokenizeLine("&:nth-child(#\{$j})");
      ...
      return expect(tokens[7]).toEqual({value: ")", scopes: ["source.css.scss", "punctuation.definition.pseudo-class.end.bracket.round.css"]});
  });
});
...
`
  ...
  describe('functions', function() {
    it('parses them', function() {
      const {tokens} = grammar.tokenizeLine('.a { hello: something($wow, 3) }');
      ...
      return expect(tokens[14]).toEqual({value: ')', scopes: ['source.css.scss', 'meta.property-list.scss', 'meta.property-value.scss', 'punctuation.section.function.scss']});
  });

    return it('tokenizes functions with parentheses in them', function() {
      const {tokens} = grammar.tokenizeLine('.a { hello: something((a: $b)) }');
...
`
  ...
  describe('interpolation', function() {
    it('is tokenized within single quotes', function() {
      const {tokens} = grammar.tokenizeLine("body { font-family: '#\{$family}'; }"); // escaping CoffeeScript's interpolation
      ...
      return expect(tokens[10]).toEqual({value: '}', scopes: ['source.css.scss', 'meta.property-list.scss', 'meta.property-value.scss', 'string.quoted.single.scss', 'variable.interpolation.scss', 'punctuation.definition.interpolation.end.bracket.curly.scss']});
  });

    it('is tokenized within double quotes', function() {
      const {tokens} = grammar.tokenizeLine('body { font-family: "#\{$family}"; }');
      ...
      return expect(tokens[10]).toEqual({value: '}', scopes: ['source.css.scss', 'meta.property-list.scss', 'meta.property-value.scss', 'string.quoted.double.scss', 'variable.interpolation.scss', 'punctuation.definition.interpolation.end.bracket.curly.scss']});
  });
    ...
    it('is tokenized without quotes', function() {
      ...
      return expect(tokens[9]).toEqual({value: '}', scopes: ['source.css.scss', 'meta.property-list.scss', 'meta.property-value.scss', 'variable.interpolation.scss', 'punctuation.definition.interpolation.end.bracket.curly.scss']});
  });

    it('is tokenized as a class name', function() {
      const {tokens} = grammar.tokenizeLine('body.#\{$class} {}');
      ...
      return expect(tokens[4]).toEqual({value: '}', scopes: ['source.css.scss', 'entity.other.attribute-name.class.css', 'variable.interpolation.scss', 'punctuation.definition.interpolation.end.bracket.curly.scss']});
  });

    it('is tokenized as a keyframe', function() {
      const {tokens} = grammar.tokenizeLine('@keyframes anim { #\{$keyframe} {} }');
      ...
      return expect(tokens[9]).toEqual({value: '}', scopes: ['source.css.scss', 'meta.at-rule.keyframes.scss', 'variable.interpolation.scss', 'punctuation.definition.interpolation.end.bracket.curly.scss']});
  });
...
`
      ...
      return expect(tokens[2][3]).toEqual({value: '*/', scopes: ['source.css.scss', 'meta.at-rule.keyframes.scss', 'comment.block.scss', 'punctuation.definition.comment.scss']});
  });
});
});
