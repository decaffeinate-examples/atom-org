...
describe('ScopeSelector', function () {
  describe('.matches(scopes)', function () {
    it('matches the asterisk', function () {
      ...
      return expect(new ScopeSelector('a.*.c').matches(['a.b.d.c'])).toBeFalsy()
    })

    it('matches segments', function () {
      ...
      return expect(new ScopeSelector('a_b_c').matches(['a_b'])).toBeFalsy()
    })

    it('matches prefixes', function () {
      expect(new ScopeSelector('R:g').matches(['g'])).toBeTruthy()
      return expect(new ScopeSelector('R:g').matches(['R:g'])).toBeFalsy()
    })
    ...
    it('matches disjunction', function () {
      ...
      return expect(new ScopeSelector('a|b|c').matches(['d'])).toBeFalsy()
    })
    ...
    it('matches negation', function () {
      ...
      expect(new ScopeSelector('a -b').matches(['a', 'b'])).toBeFalsy()
      expect(new ScopeSelector('a -c').matches(['a', 'b'])).toBeTruthy()
      return expect(new ScopeSelector('a-c').matches(['a', 'b'])).toBeFalsy()
    })
    ...
    it('matches conjunction', function () {
      ...
      expect(new ScopeSelector('a & -b').matches(['a', 'b', 'd'])).toBeFalsy()
      return expect(new ScopeSelector('a & -b').matches(['a', 'd'])).toBeTruthy()
    })
    ...
    it('matches composites', function () {
      ...
      return expect(new ScopeSelector('a,').matches(['b', 'c'])).toBeFalsy()
    })
    ...
    it('matches groups', function () {
      ...
      return expect(new ScopeSelector('(a,b) | (c, d)').matches(['e'])).toBeFalsy()
    })
    ...
    it('matches paths', function () {
      ...
      return expect(new ScopeSelector('a b e').matches(['a', 'b', 'c', 'd', 'e'])).toBeTruthy()
    })

    return it('accepts a string scope parameter', function () {
      expect(new ScopeSelector('a|b').matches('a')).toBeTruthy()
      expect(new ScopeSelector('a|b').matches('b')).toBeTruthy()
      expect(new ScopeSelector('a|b').matches('c')).toBeFalsy()
      return expect(new ScopeSelector('test').matches('test')).toBeTruthy()
    })
  })

  describe('.getPrefix(scopes)', () => it('returns the prefix if it exists and if it matches the scopes', function () {
    ...
    return expect(new ScopeSelector('L:a, R:b').getPrefix('b')).toEqual('R')
  }))

  describe('.toCssSelector()', () => it('converts the TextMate scope selector to a CSS selector', function () {
    ...
    expect(new ScopeSelector('a, b').toCssSelector()).toBe('.a, .b')
    return expect(new ScopeSelector('c++').toCssSelector()).toBe('.c\\+\\+')
  }))

  return describe('.toCssSyntaxSelector()', () => it('converts the TextMate scope selector to a CSS selector prefixing it `syntax--`', function () {
    ...
    expect(new ScopeSelector('a, b').toCssSyntaxSelector()).toBe('.syntax--a, .syntax--b')
    return expect(new ScopeSelector('c++').toCssSyntaxSelector()).toBe('.syntax--c\\+\\+')
  }))
})
