...
describe('JavaScript grammar', function () {
  ...
  describe('strings', function () {
    it('tokenizes single-line strings', function () {
      ...
      return (() => {
        const result = []
        for (const scope in delimsByScope) {
...
` + delim
    ...
    return describe('Unicode escape sequences', function () {
      ...
      it('highlights sequences with invalid syntax', () => (() => {
        const result = []
        for (const invalid of ['\\u', '\\u{2000', '\\u{G}']) {
      ...
      return it('highlights sequences with invalid codepoints', function () {
        ...
        return (() => {
          const result = []
          for (const codepoint of [0x5000, 0x11FFFF, 0x1000000, maxCodepoint]) {
  ...
  describe('numbers', function () {
    it('tokenizes hexadecimals', function () {
      ...
      return expect(tokens[0]).toEqual({ value: '0X1D306', scopes: ['source.js', 'constant.numeric.hex.js'] })
    })
    ...
    it('tokenizes binary literals', function () {
      ...
      return expect(tokens[0]).toEqual({ value: '0B011101110111010001100110', scopes: ['source.js', 'constant.numeric.binary.js'] })
    })
    ...
    it('tokenizes octal literals', function () {
      ...
      return expect(tokens[0]).toEqual({ value: '0010', scopes: ['source.js', 'constant.numeric.octal.js'] })
    })
    ...
    it('tokenizes decimals', function () {
      ...
      expect(tokens[1]).toEqual({ value: '.', scopes: ['source.js', 'constant.numeric.decimal.js', 'meta.delimiter.decimal.period.js'] })
      return expect(tokens[2]).toEqual({ value: 'E3', scopes: ['source.js', 'constant.numeric.decimal.js'] })
    })
    ...
    return it('does not tokenize numbers that are part of a variable', function () {
      ...
      return expect(tokens[0]).toEqual({ value: 'hi_1', scopes: ['source.js'] })
    })
  })
  ...
  describe('constants', function () {
    ...
    it("doesn't tokenise constants without alphabetic characters", () => (() => {
      const result = []
      for (const name of ['$_', '$', '_', '$_$_$_$___$___$____$']) {
