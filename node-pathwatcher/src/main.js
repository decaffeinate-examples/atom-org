...
class PathWatcher {
  ...
  constructor(filePath, callback) {
    ...
    for (let watcher of Array.from(handleWatchers.values())) {
...
exports.closeAllWatchers = function() {
  if (handleWatchers != null) {
    for (let watcher of Array.from(handleWatchers.values())) { watcher.close(); }
...
exports.getWatchedPaths = function() {
  const paths = [];
  if (handleWatchers != null) {
    for (let watcher of Array.from(handleWatchers.values())) { paths.push(watcher.path); }
  }
  return paths;
};
