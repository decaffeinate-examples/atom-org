...
var isValidGitDirectorySync = directory => // To decide whether a directory has a valid .git folder, we use
...
// node_modules/git-utils/deps/libgit2/src/repository.c.
  directory.getSubdirectory('objects').existsSync() &&
    directory.getFile('HEAD').existsSync() && directory.getSubdirectory('refs').existsSync()
